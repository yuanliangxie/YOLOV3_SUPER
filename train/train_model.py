...
if __name__ == "__main__":
	...
	parser.add_argument('--config_name', type=str, default='ATR-SKY_YOLOV5', help='VOC or U-DETRAC or VOC_poly_yolo')
	parser.add_argument('--device_id', type=int, default=0, help="choose the device_id")
	parser.add_argument('--config_model_name', type=str, default='yolov5', help='you can cd ./models/model/model_factory to find model name')
