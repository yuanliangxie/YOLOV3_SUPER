...
import models.head.shufflenetv2_head as yolov3_head
import models.backbone.ShufflenetV2.shufflenetv2_with_fpn_backbone as ShufflenetV2
import models.loss.yolo_loss_baseline_module as loss
from utils.logger import print_logger
import torch

class yolov3_shulffnetv2(nn.Module):
	def __init__(self, config, logger=None, init_weight=True):
		super().__init__()
		self.backbone = ShufflenetV2.shufflenetv2_with_fpn()
...
if __name__ == '__main__':
	...
	config={"device_id":'cpu', "num_classes":1,
			...
			"ce": False, "bce": True}
	model = yolov3_shulffnetv2(config)
