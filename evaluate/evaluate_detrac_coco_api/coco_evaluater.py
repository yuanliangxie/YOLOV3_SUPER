from evaluate.evaluate_detrac_coco_api.evaluater_proto import Evaluator
...
class coco_evaluater(Evaluator):
    ...
    pred_save_path = os.path.join(current_file_path, "pred_result.json")
    gt_save_path = os.path.join(current_file_path, "Detrac_test.json")
    ...
    def eval_result(cls, config):
        ...
        cocoDt = cocoGt.loadRes(cls.pred_save_path)  # 自己的生成的结果的路径及文件名，json文件形式
