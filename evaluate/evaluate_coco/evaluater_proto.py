...
from evaluate.evaluate_coco.utils_voc import *
from evaluate.evaluate_coco.visualize import visualize_boxes
...
class Evaluator(object):
    ...
    def initial_generator(self):
        dataset = VOCDataset(list_path=self.config["test_path"], labels_path=self.config["test_labels_path"], img_size=(self.val_shape, self.val_shape),
